                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: LoginWidget(imagePath: Assets.imagesFacebookLogo)
                          ),
                          SizedBox(width: screenWidth*0.02,),
                          Expanded(
                            child: LoginWidget(imagePath: Assets.imagesGoogleLogo)
                          ),
                          SizedBox(width: screenWidth*0.02,),
                          Expanded(
                            child: LoginWidget(imagePath: Assets.imagesAppleLogo)
                          ),
                        ],
                      ),
